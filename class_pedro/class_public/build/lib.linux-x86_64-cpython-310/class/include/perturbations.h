...
struct perturbations
{
  ...
  short has_source_delta_prime_b; /**< ACÁ AGREGO LOS FLAGS do we need source for baryon density derivative? */
  short has_source_delta_prime_cdm; /**< ACÁ do we need source for cdm density derivative? */
  ...
  int index_tp_delta_prime_b;    /**< index value for baryon density derivative */
  int index_tp_delta_prime_cdm;  /**< index value for cdm density derivative */
...
struct perturbations_vector
{
  ...
  int l_max_idr;          /**< max momentum in Boltzmann hierarchy (at least 3) for interacting dark radiation */
    ...
    /*acá declaro indices de las delta_prime*/
  int index_pt_delta_prime_cdm;  
  int index_pt_delta_prime_b;
  int index_pt_delta_prime_m;
